...
func Settings() {
	items := []list.Item{
		item{title: "Сгенерировать или обновить сертификат", desc: "Генерация сертификата или обновление"},
		item{title: "Установить сертификат", desc: "Укажите полный путь к сертификату"},
		item{title: "Сконфигурировать с хранилищем", desc: "Необходим полный сертификат(1 настройка)"},
